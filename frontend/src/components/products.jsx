...
function ProductPage() {
    ...
    const updateDisplayedGadgets = (filterType, priceOrder, price) => {
    ...
    const handleFilterChange = (e) => {
        ...
        updateDisplayedGadgets(e.target.value, priceOrder, price);
    };

    // Update displayed gadgets when price order changes
    const handlePriceOrderChange = (e) => {
        setPriceOrder(e.target.value);
        updateDisplayedGadgets(filterType, e.target.value, price);
    };
    ...
    const handlePriceChange = (e) => {
        ...
        updateDisplayedGadgets(filterType, priceOrder, e.target.value);
    };
    ...
    useEffect(() => {
        ...
        const sortedGadgets = [...displayedGadgets].sort((a, b) => {
            if (sortType === 'Price') {
                return (a.gadgetPrice - b.gadgetPrice) * order;
            } else if (sortType === 'Ratings') {
                return (a.gadgetReviews.rating - b.gadgetReviews.rating) * order;
        ...
        setDisplayedGadgets(sortedGadgets);
    }, [sortType, sortOrder]);
